...
const List = () => {
  ...
  const { data, loading, error, reFetch } = useFetch(
    `/hotels?city=${destination}&min=${min || 0 }&max=${max || 234999}`
  );
      ...
      <div className="listContainer">
        <div className="listWrapper">
          <div className="listSearch">
            <h1 className="lsTitle">Pretraga</h1>
              ...
              <div className="lsOptions">
                <div className="lsOptionItem">
                  <span className="lsOptionText">
                    Minimalna cena <small>po noćenju</small>
                  </span>
                  <input
                    type="number"
                ...
                <div className="lsOptionItem">
                  <span className="lsOptionText">
                  Maksimalna cena <small>po noćenju</small>
                  </span>
                  <input
                    type="number"
